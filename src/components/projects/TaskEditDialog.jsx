...
const TaskEditDialog = ({
  ...
  const handleSave = (updatedTask) => {
    ...
    const fullUpdatedTask = { ...editedTask, ...updatedTask, id: editedTask.id };
  ...
  const getStatusStyle = () => {
    return statusStyles[editedTask.status] || { label: editedTask.status || "Unknown", color: "bg-slate-500", borderColor: "border-slate-500" };
  };
